...
Astro is a player-maintained Netrunner format which allows only a single copy of any card, including cards from the entire span of FFG's card pool through current NSG sets, with a small [banlist](/banlist).
